  ...
  return (
    <>
      ...
      {order.map((userOrder) => (
        <div
          key={userOrder._id}
          className="m-2 mb-6 rounded-lg p-8 shadow-md md:mx-20 lg:mx-auto lg:max-w-5xl"
        >
          <div className="mb-5 flex justify-between">
            <p className="text-lg font-semibold md:text-xl">
              Order Date: {new Date(userOrder.createdAt).toLocaleDateString()}
            </p>
            <p
